...
export default {
  ...
  computed: {
    ...
    tour () {
      ...
      tour.addStep({
        title: 'Land cover from 2015',
        attachTo: '#alaska_landcover_2015 right',
        highlightClass: 'tour-highlighted',
        text: `This layer provides a generalized view of the vegetation and type of land at a spatial resolution of 30 meters, generated by satellite and other data sources. Vegetation types affect the flammability of an area.`,
        when: {
          show: () => {}
        },
        beforeShowPromise: delay.bind(null, 'alaska_landcover_2015'),
        buttons: buttons
      })
